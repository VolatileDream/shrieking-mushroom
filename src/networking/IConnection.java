...
public interface IConnection {
	...
	/**
	 * Returns the address of the remote machine ( or the multicast group address ( in the case of multicast ) )
	 */
	...
	/**
	 * Queues an asynchronous write event to the connection.
	 * <br>Each call to write will produce a single call to the network layer,
	 * except in the case of TCP where multiple calls may be required to flush
	 * all the data. 
	 * @param m The byte[] to write to the connection
